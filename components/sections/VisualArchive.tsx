          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-white/10 pb-6">
            <div>
              ...
              <h2 className="text-3xl sm:text-5xl md:text-6xl font-extralight tracking-tight uppercase text-white mt-1">
                EVIDENCE OF <span className="font-editorial italic font-normal text-white/90">AN ERA.</span>
              </h2>
            </div>
        ...
        <div className="flex flex-col gap-14 sm:gap-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div
              ...
              data-cursor="VIEW"
              className="md:col-span-8 group relative rounded-2xl overflow-hidden border border-white/15 aspect-[16/9] sm:aspect-[16/10] cursor-pointer shadow-2xl bg-black/40"
            >
              <Image
                src="/THE GIRAGON.png"
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6 justify-between">
                <div>
                  <span className="text-[9px] font-mono tracking-widest uppercase text-[#B76E79] block">
                    WORLDBUILDING // 2026
                  </span>
            ...
            <div
              ...
              data-cursor="VIEW"
              className="md:col-span-4 group relative rounded-2xl overflow-hidden border border-white/15 aspect-[3/4] cursor-pointer shadow-2xl bg-black/40"
            >
              <Image
                src="/girgonglory.png"
          ...
          <div className="py-12 sm:py-16 px-8 sm:px-16 border-y border-white/10 bg-white/[0.02] rounded-2xl backdrop-blur-md flex flex-col items-center text-center">
            <span className="text-[9px] font-mono tracking-[0.35em] uppercase text-[#B76E79] mb-3">
              CREATIVE DIRECTIVE
            </span>
            <p className="font-editorial text-2xl sm:text-4xl md:text-5xl font-light text-white/90 max-w-3xl leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            <div
              ...
              data-cursor="VIEW"
              className="md:col-span-5 group relative rounded-2xl overflow-hidden border border-white/15 aspect-square cursor-pointer shadow-2xl bg-black/40"
            >
              <Image
            ...
            <div
              ...
              data-cursor="VIEW"
              className="md:col-span-7 group relative rounded-2xl overflow-hidden border border-white/15 aspect-[4/3] cursor-pointer shadow-2xl bg-black/40"
            >
              <Image
