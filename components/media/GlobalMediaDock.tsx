  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 select-none">
      <motion.div
        ...
        className="bg-white/95 backdrop-blur-xl rounded-full p-2 pl-3 pr-4 flex items-center gap-3 text-[#1a1a1a] shadow-xl border border-[#1a1a1a]/15"
      >
        {/* Play/Pause Button */}
        <button
          ...
          className="w-8 h-8 rounded-full bg-[#1a1a1a] text-white hover:bg-[#B76E79] flex items-center justify-center transition-all cursor-pointer shadow-md"
        >
        ...
        >
          <div className="flex items-center gap-1.5">
            ...
            <span className={`w-1.5 h-1.5 rounded-full ${isPlaying ? 'bg-emerald-500 animate-pulse' : 'bg-[#1a1a1a]/20'}`} />
          </div>
