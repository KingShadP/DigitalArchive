...
- **Respect TypeScript** interfaces and types (e.g. `Artifact` schema in page.tsx). Fix type issues rather than ignoring them.
...
- Hover states and interactions should have meaning, not just change opacity (e.g. magnetic elements, cursor inversion).

## 5. Process & Validation
- **Run relevant validation before completion** (`npm run build`, `npm run lint`).
